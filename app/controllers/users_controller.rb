class UsersController < ApplicationController
  ...
  private
  def user_params
    params.require(:user).permit(:username, :password, :password_confirmation, user_profile_attributes: [:age, :biography, :region, :experience_years, :favorite_fishing_type])
  end
